...
# Do I need control flow lines as class? This then seems a bit complex to be also writable by hand
...
# every action needs an execute()
# ecery action needs an on_finished and on_started and on_error
