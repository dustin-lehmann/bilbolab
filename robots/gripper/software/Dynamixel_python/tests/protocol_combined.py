...
# Control table param_name for Dynamixel MX
ADDR_MX_TORQUE_ENABLE       = 64               # Control table param_name is different in Dynamixel model
ADDR_MX_GOAL_POSITION       = 116
ADDR_MX_PRESENT_POSITION    = 132

# Control table param_name for Dynamixel PRO
